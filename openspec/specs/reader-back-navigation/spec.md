# reader-back-navigation Specification

## Purpose
In-app Back and chapter-to-chapter history semantics for the manga reader so exit returns to the previous page (e.g. Library) instead of ping-ponging with manga Detail.
