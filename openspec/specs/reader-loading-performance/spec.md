...
## Purpose
Faster chapter page resolution via a short-TTL shared page-list cache, plus immediate skeleton/placeholder UX in the reader while metadata and first scans load.
