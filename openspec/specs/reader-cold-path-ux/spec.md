# reader-cold-path-ux Specification

## Purpose
Unblock chapter scans from manga-info latency, warm page lists on chapter intent, and show loading entertainment only during prolonged (cold) waits—not on warm/cache hits.
