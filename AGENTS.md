...
- `docs/MANGA_SOURCE.md` — Catálogo Consumet (self-hosted)
- `docs/MANGADEX_MIGRATION_PLAN.md` — Plan histórico MangaDex (superseded)
...
- `docs/TESTING.md` — Estrategia de testing + cómo probar Inngest
...
Next.js 15 (App Router), Clerk, Prisma 6 + Neon, Stripe, Resend, Inngest, Consumet, Playwright, Tailwind v4 + shadcn.

## Pendiente conocido

- Catálogo vía **Consumet** self-hosted; Neon solo estado de usuario (`provider` + ids externos).
- Prioridad de validación: manual + Jest mappers; Playwright en el repo (`docs/TESTING.md`).
